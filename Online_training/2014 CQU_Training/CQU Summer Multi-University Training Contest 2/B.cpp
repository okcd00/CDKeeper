...
/*
int badcmp(const void *p1,const void *p2) 
{
	if(((pair<pii,pii> *)p1)->first.first != ((pair<pii,pii> *)p2)->first.first)  
        return ((pair<pii,pii> *)p1)->first.first -((pair<pii,pii> *)p2)->first.first;  
    if(((pair<pii,pii> *)p1)->first.second!=((pair<pii,pii> *)p2)->first.second)  
        return ((pair<pii,pii> *)p1)->first.second-((pair<pii,pii> *)p2)->first.second;  
    if(((pair<pii,pii> *)p1)->second.first!=((pair<pii,pii> *)p2)->second.first)  
    	return ((pair<pii,pii> *)p2)->second.first-((pair<pii,pii> *)p1)->second.first;  
	return ((pair<pii,pii> *)p2)->second.second-((pair<pii,pii> *)p1)->second.second;  
}
*/
